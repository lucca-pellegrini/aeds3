...
public class Menu {
	...
	public static void main(String[] args) throws Exception {
		...
		while (acao != 0) {
			...
			switch (acao) {
				...
				case 4 -> delete();
				case 5 ->
					System.err.println("\033[1;31mOrdenação externa não implementada\033[0m\"");
	...
	public static void create() throws Exception {
		...
		while (cont == 1) {
			...
			System.out.print(
					"Digite 1 para adicionar outra track ou outro qualquer número para parar: ");
			cont = sc.nextInt();
		}
	}
	 ...
	 * System.out.
	 * println("Por qual característica você irá querer para fazer a leitura?");
	 * int acao3 = 20;
	 *
	 * while (acao3 != 0) {
	 * System.out.
	 ...
	 * }
	 * case 2 -> track = db.read(TrackField.GENRES, lerLista("Genres (separados por
	 * vírgula):")); case 3 -> track = db.read(TrackField.ARTISTS, lerLista("Track
	 * Artists (separados
	 * por vírgula):")); case 4 -> { System.out.print("Album Name: "); String
	 * albumName =
	 * sc.nextLine(); track = db.read(TrackField.ALBUM_NAME, albumName);
	 * }
	 * case 5 -> {
	 * System.out.print("Album Type: ");
	 ...
	 * }
	 * }
	 * case 9 -> track = db.read(TrackField.DANCEABILITY,
	 * lerFloat("Danceability:"));
	...
	private static List<String> lerLista(String mensagem) {
		...
		return Arrays.stream(entrada.split(",")).map(String::trim).collect(Collectors.toList());
	}
