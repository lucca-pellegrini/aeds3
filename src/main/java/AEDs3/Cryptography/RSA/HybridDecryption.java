...
public class HybridDecryption {
	 ...
	 * @param outputFilePath    Caminho do arquivo onde será salvo o conteúdo
	 *                          descriptografado.
	 * @param privateKey        Chave privada RSA usada para descriptografar a chave
	 *                          AES.
	 * @throws Exception Caso ocorra erro durante o processo de descriptografia.
	 */
	public static void decryptFileWithRSA_AES(String encryptedFilePath, String outputFilePath, PrivateKey privateKey)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		decryptFileWithRSA_AES("src/main/java/AEDs3/Cryptography/RSA/secure.bin",
				"src/main/java/AEDs3/Cryptography/RSA/recovered_original.bin", privateKey);
	}
}
